    ...
    render() {
        ...
        return(
            ...
            <form>
                <table> 
                    <div className="id">
                        <input className="id-box" value={areaNo} onChange={this.onAreaNo} />
                        <input className="id-box" value={distripId} onChange={this.onDistripId} />
                        <input className="id-box" value={agencyId} onChange={this.onAgencyId} />
                        <input className="id-box" value={memCourId} onChange={this.onMemCourId} />
                    </div>
                    <div> 
                        <input className="pw" type="password" value={password} onChange={this.onPassword}/>
                    </div>
                </table>
                <button className="btn btn-primary btn-block" onClick={this.onViewData}
                        style={{width:'360px', textAlign:'center', margin:'0 auto'}}>
                            Login
                </button>
            </form>
            </div>
