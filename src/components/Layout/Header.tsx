       ...
       if(window.confirm("로그아웃 하시겠습니까?") === true) {
        ...
        const shopManagement = (
          <Menu>
            ...
            <Menu.Item key="3">
              <a href="void:0"onClick={ShowModalShop}>상점등록</a>
            </Menu.Item>
        </Menu>
      );
        const riderManagement = (
          <Menu>
            ...
            <Menu.Item key="2">
              <a href="void:0" onClick={ShowModalRider}>기사등록</a>
            </Menu.Item>
        </Menu>
      );
    ...
    return (
        <header className="header">
            <div className="menu">
                ...
                <RiderSignupModal visible={isModalRiderVisible} onOk={RiderOkData} onCancel={RiderCancelData}/>
