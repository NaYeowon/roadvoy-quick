...
{
  state = { astManageDistributor: [] }

async fetchDistributorList() 
{
    try 
    {
        ...
        this.setState({
            astManageDistributor: response.data.astManageDistributor
        })
    } 
    catch(e) 
    {
...
componentDidMount()
{
  this.fetchDistributorList = this.fetchDistributorList.bind(this);
    ...
    render() {
        ...
        return (
            <div>
                ...
                <PageHeader>
                  <span>
                      <b>{this.state.astManageDistributor?.length}</b>개의 가맹점이 등록 되어있습니다.
                  </span>
                ...
                <Table
                  columns={columns}
                  bordered
                  dataSource={this.state.astManageDistributor}
